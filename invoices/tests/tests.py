...
class InvoiceTests(TestCase):
    def setUp(self):
        ...
        self.invoice_item1 = InvoiceItem.objects.create(
            invoice=self.invoice, item="Test Line Item", quantity=3, rate=20, tax=0,
        )

        self.invoice_item2 = InvoiceItem.objects.create(
            invoice=self.invoice, item="Test Line Item 2", quantity=1, rate=20, tax=0,
        )
        self.invoice.save()
...
class ClientTests(TestCase):
    def setUp(self):
        ...
        self.invoice_item1 = InvoiceItem.objects.create(
            invoice=self.invoice2, item="Test Line Item", quantity=3, rate=20, tax=0,
        )

        self.invoice_item2 = InvoiceItem.objects.create(
            invoice=self.invoice2, item="Test Line Item 2", quantity=1, rate=20, tax=0,
        )
